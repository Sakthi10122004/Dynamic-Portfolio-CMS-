  ...
  <style>
    ...
    *::after {
    ...
    .login-brand-icon {
      ...
      color: white;
      margin: 0 auto 1rem;
      box-shadow: 0 8px 24px rgba(240, 74, 0, .4);
    }
    ...
    .status-pill {
      ...
      align-items: center;
      gap: .4rem;
      background: rgba(0, 212, 158, .1);
      border: 1px solid rgba(0, 212, 158, .3);
      color: #00a87e;
      border-radius: 100px;
      padding: .28rem .8rem;
      font-size: .72rem;
    ...
    .btn-submit:hover {
      ...
      box-shadow: 0 8px 28px rgba(240, 74, 0, .35)
    }
    ...
    <div class="login-box">
      <div class="login-logo">
        <div class="login-brand-icon">
          <svg width="26" height="26" fill="none" stroke="white" stroke-width="2" stroke-linecap="round"
      ...
      <form method="POST" action="" class="login-form">
        ...
        <div class="fg">
          ...
          <div class="pw-wrap">
            <input type="password" id="password" name="password" placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢"
