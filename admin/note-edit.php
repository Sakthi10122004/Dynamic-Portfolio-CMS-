    ...
    <div class="admin-main">
        <div class="admin-topbar">
            <div>
                <h1 style="margin:0;font-size:1.4rem;font-weight:700;color:var(--text-strong)">
                    <i class="fa-solid fa-<?php echo $id ? 'pen' : 'plus'; ?>" style="color:var(--accent)"></i> <?php echo $id ? 'Edit Post' : 'New Post'; ?>
                </h1>
                <p style="font-size:.83rem;color:var(--text-muted);margin-top:.1rem">Draft and publish articles to your digital garden</p>
            </div>
        ...
        <div class="admin-card">
            ...
            <div class="field">
                ...
                <textarea id="excerpt" name="excerpt" rows="2" placeholder="Brief summary shown on the blog index..."><?php echo escape($note['excerpt'] ?? $_POST['excerpt'] ?? ''); ?></textarea>
            ...
            <div class="field">
                ...
                <textarea id="content" name="content" rows="15" required placeholder="Write your post content here..."><?php echo escape($note['content'] ?? $_POST['content'] ?? ''); ?></textarea>
            ...
            <div class="field" style="display:flex; align-items:center; gap:0.6rem">
                ...
                <label for="published" style="margin-bottom:0; cursor:pointer">
                    <i class="fa-solid fa-paper-plane" style="font-size:0.8rem; margin-right:0.3rem"></i> Publish this post
                </label>
            </div>
