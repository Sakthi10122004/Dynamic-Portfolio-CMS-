...
// Delete — now via POST for security (GET kept for backward compat with CSRF check)
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
  verifyCsrf();
  $db->query("DELETE FROM social_links WHERE id=?", [(int) $_POST['delete_id']], 'i');
  ...
  if (!$platform || !$url) {
    ...
    if ($editId > 0) {
      $db->query(
        ...
        [$platform, $url, $icon, $order, $editId],
        'sssii'
      );
  ...
  <div class="admin-main">
    <div class="admin-topbar">
      <div>
        ...
        <p style="font-size:.83rem;color:var(--text-muted);margin-top:.1rem">Manage social media profiles and external
          links</p>
      </div>
    ...
    <div class="social-layout" style="display:grid;grid-template-columns:1fr 1.5fr;gap:1.5rem;align-items:start">

      <!-- Add / Edit Form -->
      <div class="admin-card">
        <div class="admin-card-header">
          <h2><i class="fa-solid fa-<?php echo $editItem ? 'pen' : 'plus'; ?>"></i>
            <?php echo $editItem ? 'Edit Link' : 'Add New Link'; ?></h2>
        </div>
          ...
          <form method="POST" class="admin-form">
            ...
            <div class="field">
              ...
              <input type="text" id="platform" name="platform" required
                value="<?php echo escape($editItem['platform'] ?? ''); ?>" placeholder="e.g. GitHub">
            </div>

            <div class="field">
              <label for="url">Profile URL <span style="color:#f87171">*</span></label>
              <input type="url" id="url" name="url" required value="<?php echo escape($editItem['url'] ?? ''); ?>"
            ...
            <div class="field">
              ...
              <input type="text" id="icon_class" name="icon_class"
                value="<?php echo escape($editItem['icon_class'] ?? 'fab fa-github'); ?>" placeholder="fab fa-github">
                  ...
                  <?php foreach ($links as $l): ?>
                    <tr>
                      <td>
                        ...
                        <span
                          style="font-size:.75rem;color:var(--text-muted)"><?php echo escape(substr($l['url'], 0, 35)) . '...'; ?></span>
                      </td>
                      ...
                      <td>
                        <div class="actions-cell">
                          ...
                          <form method="POST" style="display:inline" onsubmit="return confirm('Delete this social link?')">
                            <?php echo csrfField(); ?>
